# Install the Azure Form Recognizer (the previous name for Document Intelligence) SDK package first -> pip install azure-ai-formrecognizer==3.3.3
...
endpoint = os.getenv("SVC_ENDPOINT")
